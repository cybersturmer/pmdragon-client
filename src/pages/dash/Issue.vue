...
export default {
  ...
  async mounted () {
    this.formData.issue = this.$store.getters['issues/ISSUE_BY_ID'](parseInt(this.id))
    this.issueStates = this.$store.getters['issues/ISSUE_STATES_BY_CURRENT_PROJECT']
    this.issueTypes = this.$store.getters['issues/ISSUE_TYPES_BY_CURRENT_PROJECT']
    this.participants = this.$store.getters['auth/PARTICIPANTS_BY_CURRENT_PROJECT']
